...
import tmit.bme.telkicar.logic.matching.IntegerLinearProgrammingMatcher;
...
//		Class.forName(env.getProperty("spatialDb.datasource.driver-class-name"));
	...
	@Bean(name = "matcher")
	@Scope("prototype") // new instance every time
	public ParticipantMatcher participantMatcher() {
		return new IntegerLinearProgrammingMatcher(spatialRepository);
	}
